#CH03_02
#single linked list insert new node
...
while(True):
    ...
    if position ==-1:
        ...
        ptr = finnode(head,position)
        new_num = int(input('請輸入新插入的員工編號:'))
        new_salay = int(input('請輸入新插入的員工薪水:'))
        new_name = input('請輸入新插入的員工姓名:')
        head = insertnode(head,ptr,new_num,new_salay,new_name)
    print()
